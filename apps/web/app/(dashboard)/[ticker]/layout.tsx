...
const NAV_ITEMS: { href: string; label: string; index: number }[] = [
  ...
  { href: "/historical", label: "Historical Trends", index: 3 },
  { href: "/valuation", label: "Valuation", index: 4 },
  { href: "/dcf", label: "DCF", index: 5 },
  { href: "/comps", label: "Comps", index: 6 },
  { href: "/sotp", label: "SOTP", index: 7 },
  { href: "/scenarios", label: "Scenarios", index: 8 },
  { href: "/sensitivities", label: "Sensitivities", index: 9 },
  { href: "/reverse-valuation", label: "Reverse Valuation", index: 10 },
  { href: "/value-unlock", label: "Value Unlock", index: 11 },
  { href: "/ai-analyst", label: "AI Analyst", index: 12 },
  { href: "/risks", label: "Risks", index: 13 },
  { href: "/research-history", label: "Research History", index: 14 },
  { href: "/memo", label: "Investment Memo", index: 15 },
  { href: "/data-integrity", label: "Data Integrity", index: 16 },
];
